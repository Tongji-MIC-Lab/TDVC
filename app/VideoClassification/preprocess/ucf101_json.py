...
if __name__ == '__main__':
    ...
    parser.add_argument('--dir_path',
                        default='/mnt/dataset/videocls/UCF101TrainTestSplits-RecognitionTask/ucfTrainTestlist',
                        type=Path,
                        help=('Directory path including classInd.txt, '
                              'trainlist0-.txt, testlist0-.txt'))
    parser.add_argument('--video_path',
                        default='/mnt/dataset/videocls/UCF101/UCF-101_yuv_compress_22_img',
                        type=Path,
                        help=('Path of video directory (jpg).'
                              'Using to get n_frames of each video.'))
    parser.add_argument('--dst_path',
                        default='/mnt/dataset/videocls/UCF101/UCF-101_yuv_compress_22_img_json',
                        type=Path,
