...
def read_flow(filename):
    ...
    :return: optical flow dataset in matrix
    """
    f = open(filename, 'rb')
    try:
    ...
    if 202021.25 != magic:
        ...
        # reshape dataset into 3D array (columns, rows, channels)
...
def read_image(filename):
    ...
    :return: image dataset in matrix uint8 type
    """
...
def save_flow_image(flow, image_file):
    ...
    :param flow: optical flow dataset
    :param flow_fil
    :return: None
    """
